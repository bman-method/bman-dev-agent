...
- [ ] TASK-6: In the files auto completion, do not show the full path of the file, just the relative path to the current folder. Also when the file is selected, write the relative path in the editor.
