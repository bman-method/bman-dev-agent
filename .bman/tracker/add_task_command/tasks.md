...
- [x] TASK-4: The function addTask must not be defined in cli.ts. It belongs to the tracker module. The tracker module shoud expose addTask function as part of its interface - update types.ts if needed.
