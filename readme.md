...
- Explain every change: the output contract (`src/outputContract.ts`) requires structured `aiThoughts` sections; the commit formatter embeds them in the commit body alongside the task and human-style message.
